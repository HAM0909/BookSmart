...
import os
from livres_router import router as livres_router
from emprunts_router import router as emprunts_router


app = FastAPI(title="Book Reservation API")
...
app = FastAPI(title="Book Reservation API (Ré")
...
def reserver_un_livre(id_livre: int, id_adherent: int):
    ...
    print(" trying to reserve:", id_livre, "for user:", id_adherent)
    ...
    try:
        ...
        if existing:
            return {"ok": False, "msg": "déjà réservé"}
