...
# charge les variables env sinon boom 💥
load_dotenv()

app = FastAPI(title="Book Reservation API (aka Réserver un livre)")

# TODO: maybe changer le path... mais là ça marche ¯\_(ツ)_/¯
...
def reserver_un_livre(id_livre: int, id_adherent: int):
      conn = get_db()     # note: pas de pool -> pas grave pour now
      cur = conn.cursor()
