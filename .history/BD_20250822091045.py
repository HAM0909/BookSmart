...
try:
    ...
    df = pd.read_csv('livres_brut.csv')
    ...
    # Charger les descriptions depuis la base
    descriptions = pd.read_sql("SELECT description FROM livres", engine)
    
    # Créer et entraîner le TF-IDF Vectorizer
    ...
    # Sauvegarder les données dans un fichier pickle pour utilisation ultérieure
